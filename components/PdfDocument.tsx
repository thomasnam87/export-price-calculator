...
export default function PdfDocument({ inputs, results }: Props) {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSub}>Happy Viet Ltd. · happyvietltd@gmail.com · Date: {today}</Text>
        </View>
        ...
        <Text style={styles.footer}>
          This quotation is valid for 15 days. Generated by Export Price Calculator · Happy Viet Ltd.
        </Text>
      </Page>
    </Document>
  );
